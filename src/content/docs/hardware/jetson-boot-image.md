...
Not filed upstream as of this page. See [Known upstream issues](../../reference/known-issues/) for the related, already-tracked gap that `avocado deploy` never carries the kernel or kernel DTB at all.
